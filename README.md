...
This app is fortune-telling and shows how developers can use the Stateful Widget. Correspondingly, you see the Card Widget in the Column. This widget helps to make a scalable box. Besides, these Card Widgets have onTap property. Thanks to this widget, you can click into Cards. Moreover, Card Widgets have ListTile Widget. ListTile presents Padding property. Bottom of the screen, there are fortunes and these fortunes come from the List of String. Besides, there is a Divider Widget top of the fortunes. On the other hand, the developer can see the dart: math's library. This library is used to generate a Random number. Finally, you can also see that different text font is used.
...
https://user-images.githubusercontent.com/68854616/157866599-f9f213dd-7ca7-40a9-9846-e1c7de81f355.mp4
